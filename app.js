...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    gif.src = "resources/3.shocked-1.gif";// gif credit: https://tenor.com/view/tkthao219-peach-goma-gif-25008901
    text.innerHTML = "难道你是真忘完我的好吗?🥹";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
...
yes.addEventListener("click", () => {
  ...
  yes.innerHTML = '<a href="https://www.instagram.com/danielyen_16/?hl=en">来帮你主动一下</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
